...
//                if (FieldTypeEnum.date.name().equals(query.getType()) && query.getName().endsWith("_start") && StringUtils.isNotEmpty(query.getValue())) {
//                    sb.append(" and " + query.getName().replace("_start", "") + " > to_date('" + query.getValue() + "','YYYY-MM-DD HH24:MI:SS') ");
//                }
//                if (FieldTypeEnum.date.name().equals(query.getType()) && query.getName().endsWith("_end") && StringUtils.isNotEmpty(query.getValue())) {
//                    sb.append(" and " + query.getName().replace("_end", "") + " < to_date('" + query.getValue() + "','YYYY-MM-DD HH24:MI:SS') ");
//                }
//                if (StringUtils.isNotEmpty(query.getValue()) && !query.getName().endsWith("_end") && !query.getName().endsWith("_start")) {
