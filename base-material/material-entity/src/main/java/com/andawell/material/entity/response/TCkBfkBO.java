...
public class TCkBfkBO {
    ...
    @ApiModelProperty(value = "币种", name = "xhmc", dataType = "String")
    private String bbz="";

    @ApiModelProperty(value = "币种名称", name = "xhmc", dataType = "String")
    private String BZMC="";

    @ApiModelProperty(value = "汇率", name = "xhmc", dataType = "String")
    private BigDecimal hl=new BigDecimal("1.00");
     ...
     * HCLB
     */
    @ApiModelProperty(value = "类别", name = "HCLBMC", dataType = "Long")
